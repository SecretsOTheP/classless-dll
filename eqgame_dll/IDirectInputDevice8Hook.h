...
public:
	...
	HRESULT STDMETHODCALLTYPE EnumObjects(LPDIENUMDEVICEOBJECTSCALLBACK p0, LPVOID p1, DWORD p2);
	...
	HRESULT STDMETHODCALLTYPE BuildActionMap(LPDIACTIONFORMAT p0, LPCSTR p1, DWORD p2);
	HRESULT STDMETHODCALLTYPE SetActionMap(LPDIACTIONFORMAT p0, LPCSTR p1, DWORD p2);
	HRESULT STDMETHODCALLTYPE GetImageInfo(LPDIDEVICEIMAGEINFOHEADER p0);
};