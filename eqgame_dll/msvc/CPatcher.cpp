...
{ 
    if(byteType == X86_JMP) InstallDetourPatchInternal(dwAddress, dwTypeAddress, X86_JMP, iSize); 
    else if (byteType == X86_CALL) InstallDetourPatchInternal(dwAddress, dwTypeAddress, X86_CALL, iSize); 
} 
